...
import com.squareup.picasso.Picasso
    ...
    class AdapterPerpustakaan2(
        val listPerpustakaan: ArrayList<Perpustakaan>,
        val context: Context
    ) :
        RecyclerView.Adapter<AdapterPerpustakaan2.ViewHolder>() {

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view = LayoutInflater.from(parent.context).inflate(
                R.layout.layout_perpustakaan, parent,
                false
            )
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            val warnaklasifikasi = Color.parseColor(
                when (pengarang) {
                    "Umum" -> "#FF0000"
                    "Filsafat" -> "#FF7F00"
                    "Agama" -> "#FFFF00"
